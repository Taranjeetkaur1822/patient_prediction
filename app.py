...
bp = st.sidebar.number_input("Blood Pressure", 80, 300, 120)
cholesterol = st.sidebar.number_input("Cholesterol Level", 100, 400, 300)
...
skin_thickness = st.sidebar.number_input("Skin Thickness", 1, 100, 20)
